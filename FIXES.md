...
As specified in [AGENTS.md](./AGENTS.md):
...
### `:skaldoria-writer`
- [`WriterEditor.kt`](./skaldoria-writer/src/desktopMain/kotlin/com/skaldoria/writer/WriterEditor.kt):
...
- [`DocumentParser.kt`](./skaldoria-writer/src/desktopMain/kotlin/com/skaldoria/writer/parser/DocumentParser.kt):
...
### `:skaldoria-shared-ui`
- [`MermaidDiagramCanvas.kt`](./skaldoria-shared-ui/src/desktopMain/kotlin/com/skaldoria/ui/components/MermaidDiagramCanvas.kt):
...
- [`MathFormulaRenderer.kt`](./skaldoria-shared-ui/src/desktopMain/kotlin/com/skaldoria/ui/components/MathFormulaRenderer.kt):
...
- [`CanvasGeometry.kt`](./skaldoria-canvas/src/desktopMain/kotlin/com/skaldoria/canvas/model/CanvasGeometry.kt):
...
- [`CanvasState.kt`](./skaldoria-canvas/src/desktopMain/kotlin/com/skaldoria/canvas/state/CanvasState.kt):
...
- [`CanvasWorkspace.kt`](./skaldoria-canvas/src/desktopMain/kotlin/com/skaldoria/canvas/ui/CanvasWorkspace.kt):
...
- [`CanvasGestures.kt`](./skaldoria-canvas/src/desktopMain/kotlin/com/skaldoria/canvas/ui/CanvasGestures.kt):
...
- [`CanvasModels.kt`](./skaldoria-canvas/src/desktopMain/kotlin/com/skaldoria/canvas/model/CanvasModels.kt):
...
- [`CanvasNodeCard.kt`](./skaldoria-canvas/src/desktopMain/kotlin/com/skaldoria/canvas/ui/CanvasNodeCard.kt):
...
- [`Main.kt`](./skaldoria-canvas/src/desktopMain/kotlin/com/skaldoria/canvas/Main.kt):
...
- [`CanvasStateTest.kt`](./skaldoria-canvas/src/desktopTest/kotlin/com/skaldoria/canvas/CanvasStateTest.kt):
...
- [`CanvasNavigationTest.kt`](./skaldoria-canvas/src/desktopTest/kotlin/com/skaldoria/canvas/CanvasNavigationTest.kt):
...
- [`CanvasGeometryTest.kt`](./skaldoria-canvas/src/desktopTest/kotlin/com/skaldoria/canvas/CanvasGeometryTest.kt):
...
- [`ElementImageRenderer.kt`](./skaldoria-presentation/src/desktopMain/kotlin/com/skaldoria/export/ElementImageRenderer.kt):
  - Wired `isBlock = isBlock` into `MathFormulaRenderer`.
- [`BulletListSlide.kt`](./skaldoria-presentation/src/desktopMain/kotlin/com/skaldoria/ui/layouts/BulletListSlide.kt):
  - Wired `isBlock = elem.isBlock` into `MathFormulaRenderer`.
- [`MathFormulaSlide.kt`](./skaldoria-presentation/src/desktopMain/kotlin/com/skaldoria/ui/layouts/MathFormulaSlide.kt):
  - Wired `isBlock = elem.isBlock` into `MathFormulaRenderer`.
