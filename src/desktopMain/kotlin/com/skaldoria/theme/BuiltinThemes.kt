...
object BuiltinThemes {
    ...
    val SleekLight = PresentationTheme(
        ...
        codeKeyword = Color(0xFF4338CA),
        codeString = Color(0xFF047857),
        codeComment = Color(0xFF475569),
    ...
    val MinimalistEditorial = PresentationTheme(
        ...
        codeBackground = Color(0xFFF2ECE4),
        codeText = Color(0xFF1C1917),
        codeKeyword = Color(0xFF9A3412),
        codeString = Color(0xFF166534),
        codeComment = Color(0xFF57534E),
        codeNumber = Color(0xFF92400E),
    ...
    val DeutscheBorseExecutive = PresentationTheme(
        ...
        warning = Color(0xFFB45309),       // Deep Gold / Amber
        textPrimary = Color(0xFF0A0E1A),   // Deep crisp dark navy/black (high contrast)
        textSecondary = Color(0xFF1E293B), // Deep slate gray
        textMuted = Color(0xFF475569),     // Crisp readable gray
        codeBackground = Color(0xFFF1F5F9),// High-contrast clean code box
        codeText = Color(0xFF0A0E1A),      // Deep visible navy/black
        codeKeyword = Color(0xFF000099),   // DB Blue
        codeString = Color(0xFF007A37),    // Deep accessible green
        codeComment = Color(0xFF475569),   // Crisp comment gray
        codeNumber = Color(0xFF92400E),    // Deep gold/amber
